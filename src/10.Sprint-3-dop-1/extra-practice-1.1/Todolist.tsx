...
import {FilterValuesType} from "./App_sprint3_1.1.tsx";
...
export function Todolist(props: PropsType) {
    ...
    const changeTodolistTitle = (title: string) => {
        console.log('changeTodolistTitle', title)
    }
        ...
        <div>
            {
                props.tasks.map(t => {
                    ...
                    const onChangeHandler = (e: ChangeEvent<HTMLInputElement>) => {
                        ...
                        console.log('changeTaskStatus', newIsDoneValue)
                    }
                    const onTitleChangeHandler = (newValue: string) => {
                        console.log('changeTaskTitle', newValue)
                    }
