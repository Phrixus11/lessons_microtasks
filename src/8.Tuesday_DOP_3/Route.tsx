...
type RouteProps = {
    route: RouteType
    toggleFTIsBooked: (flightTableID: string, routeID: string, newStatusIsBooked: boolean) => void;
...
export const Route = ({
    ...
    const handleToggleFTIsBooked = (newStatusIsBooked: boolean) => {
        toggleFTIsBooked(flightTableID, route.id, newStatusIsBooked);
